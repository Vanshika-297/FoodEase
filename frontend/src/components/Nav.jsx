  ...
  return (
    ...
    >
      ...
      items-center gap-[20px] flex fixed top-[80px] left-[5%] md:hidden"
        >
          <div
            className="flex items-center w-[30%] overflow-hidden gap-[10px]
      ...
      <div className="flex items-center gap-4">
        {userData.role=="user" &&  
        (showSearch ?
          <RxCross1 size={25} className="text-[#ff4d2d] md:hidden" onClick={() => setShowSearch(false)}/>
         : 
          <IoMdSearch
            size={25}
        ...
        {showInfo && (
          <div
            className={`fixed top-[80px] right-[10px] 
              ${userData.role=='deliveryBoy'? 'md:right-[20%] lg:right-[45%]'
              :'md:right-[10%] lg:right-[25%]'}  w-[180px] bg-white
